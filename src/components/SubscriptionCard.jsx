...
// const SubscriptionCard = ({ title, price, features, buttonText, color, icon: Icon, billingCycle, isPopular, selectedTypes, discountPercent = {} }) => {
...
//                 Save {billingCycle === 'quarterly' ? '20%' : '30%'} compared to monthly
//               </p>
//             )}
